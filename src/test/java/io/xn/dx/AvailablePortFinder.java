 ...
 * <p/>
 * Modified to not reuse ports (allows grabbing ports and using them later)
 *
...
public class AvailablePortFinder
{
     ...
     */
    public static synchronized Set getAvailablePorts()
    {
     ...
     */
    public static synchronized Set getAvailablePorts(int fromPort, int toPort)
    {
        if (
